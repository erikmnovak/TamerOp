...
# Backwards-compatible constructor: no strict (">=") rows.
function HPoly(n::Int, A::Matrix{QQ}, b::Vector{QQ}, poly::Any)
    m = size(A, 1)
    return HPoly(n, A, b, poly, falses(m), STRICT_EPS_QQ)
end
...
- `naccepted`, `nproposed`   : backward-compatible aliases for the above
