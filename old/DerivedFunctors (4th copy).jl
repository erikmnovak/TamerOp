...
#
# Notes:
# - The resolved module M is stored explicitly for API clarity and symmetry with
#   ExtSpaceInjective. It should always satisfy E.M === E.res.M.
# - tmin/tmax are derived from the underlying cochain complex.
# -----------------------------------------------------------------------------
...
function Ext(res::ProjectiveResolution{QQ}, N::PModule{QQ})
    ...
    return ExtSpaceProjective{QQ}(res.M, res, N, C, offs, cohom)
end
