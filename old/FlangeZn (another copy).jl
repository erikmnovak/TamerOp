...
## NOTE:
## We intentionally keep *one* canonical set of field names on Flange:
##
##   - flats
##   - injectives
##   - Phi
##
## Earlier versions offered paper-style aliases (F/E/phi) via Base.getproperty.
## Those runtime shims have been removed to avoid API ambiguity and "magic".
