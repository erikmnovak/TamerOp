...
## NOTE:
## We intentionally avoid a Vector{Float64}-based overload here.
## The scalar helper `_dist2_point_segment_xy` is the fast, allocation-free
## building block used by the geometry code.
