...
function _generator_index_dicts(flats::Vector{IndFlat},
                                injectives::Vector{IndInj}) where {K}
...
function _critical_coords(flats::Vector{IndFlat}, injectives::Vector{IndInj}) where {K}
...
function _signature_at(g::AbstractVector{<:Integer},
                       flats::Vector{IndFlat}, injectives::Vector{IndInj}) where {K}
...
function _signature_at(g::NTuple{N,<:Integer}, flats::Vector{IndFlat}, injectives::Vector{IndInj}) where {N,K}
    y = falses(length(flats))
    z = falses(length(injectives))
