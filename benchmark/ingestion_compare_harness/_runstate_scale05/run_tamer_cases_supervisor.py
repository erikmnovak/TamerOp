...
outdir = base / "results_tamer_invariants_scale05_cases"
log = base / "_runstate_scale05" / "tamer_supervisor.log"
status = base / "_runstate_scale05" / "tamer_status.txt"
...
with log.open('w') as lf:
    for i, case in enumerate(cases, 1):
        ...
        with out.open() as fh:
            ...
            rows.extend(reader)
    combo = base / 'results_tamer_invariants_scale05.csv'
