...
outdir = base / "results_multipers_invariants_cases"
log = base / "_runstate" / "multipers_supervisor.log"
status = base / "_runstate" / "multipers_status.txt"
...
with log.open('w') as lf:
    for i, case in enumerate(cases, 1):
        ...
        with out.open() as fh:
            ...
            rows.extend(reader)
    combo = base / 'results_multipers_invariants.csv'
