...
outdir = base / "results_tamer_invariants_cases"
log = base / "_runstate" / "tamer_supervisor.log"
status = base / "_runstate" / "tamer_status.txt"
...
with log.open('w') as lf:
    for i, case in enumerate(cases, 1):
        ...
        cmd = [
            ...
            '--manifest=benchmark/ingestion_compare_harness/fixtures_invariants/manifest.toml',
            f'--out={out}', '--profile=desktop', '--invariants=all', '--degree=0', f'--case={case}',
        ]
        ...
        with out.open() as fh:
            ...
            rows.extend(reader)
    combo = base / 'results_tamer_invariants.csv'
